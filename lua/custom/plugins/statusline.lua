...
statusline.configs = function()
  local utils = require("heirline.utils")
  local conditions = require("heirline.conditions")

  local special, special2, special3 = statusline._generate_colorscheme()

  local safe_get_highlight = statusline._safe_get_highlight
  local colors = {
  ...
  local MasonStatusElement = {
    condition = function()
      return #statusline.state.installing_mason_packages > 0
    end,
    provider = function()
      local installing_mason_packages = statusline.state.installing_mason_packages
  ...
  local GitBlock = {
    condition = function()
      local has_gitsigns_module = true
...
return {
  ...
  config = function ()
    require('heirline').setup({statusline = statusline.configs()})
  end,
  init = function ()
